...
const SubmissionTable = ({
  ...
  const tableClass = isStudent
    ? "data-table submission-table student-submission-table"
    : role === "TEACHER"
    ? "data-table submission-table teacher-submission-table"
    : "data-table submission-table admin-submission-table";
